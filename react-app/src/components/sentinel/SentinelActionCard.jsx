...
export default function SentinelActionCard({ action, onDecision, isProcessing = false }) {
  ...
  return (
    <div className="glass-panel" style={{
      ...
      borderLeft: `5px solid ${config.color}`, background: 'rgba(15, 23, 42, 0.65)',
      position: 'relative'
    }}>
      {/* Card Header */}
      ...
      <div style={{
        ...
        gap: '12px', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '12px', marginTop: '2px'
      }}>
        <button
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              ...
              style={{
                ...
                color: '#ef4444', padding: '6px 12px', borderRadius: '6px', fontSize: '12px',
            ...
            <button
              ...
              style={{
                ...
                color: '#fff', padding: '6px 16px', borderRadius: '6px', fontSize: '12px',
                fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px',
