...
DO NOT wrap the output in markdown blocks. Return raw JSON.`;
        ...
        try {
            ...
            console.error('[FIRIntelligenceService] API Failed:', error.message);
            await AuditService.logEvent(req, req.user, 'Failed FIR Analysis', 'FIRIntelligence', caseId, 'FAILED').catch(() => {});
