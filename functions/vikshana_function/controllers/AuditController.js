...
class AuditController {
    ...
    static async getLogs(req, res) {
        try {
            ...
            return res.status(500).json({ success: false, error: error.message || 'Failed to fetch audit logs', data: [] });
        }
    }
    ...
    static async createLog(req, res) {
        try {
            ...
            return res.status(500).json({ success: false, error: error.message || 'Failed to create audit log', data: null });
        }
    }
}
